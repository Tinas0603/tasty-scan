      ...
      <section className='bg-secondary  py-20 px-4 md:px-6 lg:px-8'>
        <div className='max-w-4xl text-center'>
          <h1 className='text-4xl font-bold sm:text-5xl md:text-6xl'>
            Về Bếp ẩm thực TastyScan
          </h1>
          <p className='mt-4 text-lg md:text-xl'>
            Địa chỉ: Hutech khu E, Xa lộ Hà Nội, Khu CNC, Hiệp Phú, Quận 9, TP HCM
          </p>
        </div>
      </section>
        ...
        <div className='max-w-4xl space-y-8'>
          <div>
            ...
            <p className='mt-4 text-muted-foreground leading-8'>
              TastyScan được thành lập vào năm 2024 với một sứ mệnh đơn giản: phục
          ...
          <div>
            ...
            <p className='mt-4 text-muted-foreground leading-8'>
              Tại trung tâm của TastyScan là sự cống hiến sâu sắc cho tính bền
